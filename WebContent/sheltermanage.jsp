  ...
  <table>
     <thead>
      ...
      <tbody>
       ...
       con=dbconn.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM disastermanagement.selterreg s");
      ...
      <td data-label="Invoice"><%= rs.getString(2) %></td>
          ...
          <td data-label="Payment"><a href="shelterapprove.jsp?shelterid=<%=rs.getString(2)%>"><button class="btn-invoice">Activate </button></a></td>
          <td data-label="Payment"><a href="shelterreject.jsp?shelterid=<%=rs.getString(2)%>"><button class="btn-outvoice">Reject</button></a></td>
        </tr>

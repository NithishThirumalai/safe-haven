...
<body>
    ...
    <section class="header">
        <div class="container">
            <nav>
                <div class="logo"><h1>DISASTER MANAGEMENT</h1></div>
                <div class="navbar">
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="voluntlog.jsp">Volunteer</a></li>
                        <li><a href="governmentlog.jsp">Governement</a></li>
            ...
            <div class="hero">
                <div class="hero-content">
                    ...
                    <p class="hero-desc">
                        Please give the information about Disaster  by clicking the Button below to Register.
                        <br>
                        <br>
                    <button class="btn"><a href="disastercomplaint.jsp">COMPALINT</a></button>
                </div>
                <div class="hero-img">
    ...
    <section class="slogan">
        <div class="container padding-lg">
            <div class="slogan-content">
                <p class="slogan-text">We cannot stop natural disasters but we can arm ourselves with knowledge: so many lives wouldnt have to be lost if there was enough disaster preparedness.</p>

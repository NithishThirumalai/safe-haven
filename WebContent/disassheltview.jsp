...
<br>
  <table class="rwd-table">
    <tbody>
      ...
      String location=session.getAttribute("location1").toString();
     ...
     /* PreparedStatement ps=con.prepareStatement("SELECT * FROM studentmanage.lecturereg l where status='Not_Activate' ");  */
      ...
      <tr>
        ...
        <td data-th="Net Amount">
          <%= rs.getString(14) %>
         <td data-th="Net Amount">
         <a href="sheltsentgovern.jsp?email=<%=rs.getString(3)%>"><button type="button" class="btn btn-outline-success">Approval</button></a>
        </td>
        
         <td data-th="Net Amount">
        <a href="sheltgovesupport.jsp?email=<%=rs.getString(3)%>"><button type="button" class="btn btn-outline-warning">Support</button></a>
        </td>
        </td>
      </tr>
     <%} %>

...
.logo{
background: transparent linear-gradient(90deg, #167ce9 0%, #1487e9 100%) 0% 0% no-repeat padding-box;
color:#000;
padding:25px;
width:230px;
position:absolute;
...
<a href="dismedicalview.jsp">DISASTER</a>
 <a href="medviewapproved.jsp">VIEW</a> 
 <!-- <div class="dropdown"> 
